...
const iconMap = {
	projects: <Code2 className="w-6 h-6" />,
	internships: <Briefcase className="w-6 h-6" />,
	academics: <GraduationCap className="w-6 h-6" />
};
						...
						{achievements.map((achievement) => (
							<ScrollAnimation key={achievement.title}>
								<div className="bg-white/5 p-6 rounded-xl backdrop-blur-sm">
									<div className="text-white mb-4">{iconMap[achievement.key as keyof typeof iconMap]}</div>
