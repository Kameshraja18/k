				...
				<div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12">
					...
					<div className="space-y-4">
						...
						<p className="text-sm text-gray-400">
							Software Developer based in Villupuram, Tamilnadu, India.
						</p>
					</div>
					...
					<div className="space-y-4">
						...
						<ul className="space-y-3">
							<li>
								<a href="mailto:k.s.kameshraja@gmail.com" className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2">
